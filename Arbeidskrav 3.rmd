...
```{r laste inn pakker, echo=FALSE, warning=FALSE, message = FALSE}
library(readxl)
library(tidyverse)
library(broom)
library(knitr)
...
```{r kjøre t-test, warning=FALSE, results = "asis"}
...
```{r kjøre regresjonsanalyse, warning=FALSE, results = "asis"}
